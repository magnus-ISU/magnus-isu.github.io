import{j as e,k as t,yt as n}from"./Bgl5u5va.js";import"./DhStUcXh.js";import"./Cxh5GPy4.js";var r=e(`<h1 id="playing-the-game"><a aria-hidden="true" tabindex="-1" href="#playing-the-game"><span class="icon icon-link"></span></a>Playing the Game</h1> <p>Playing Dungeon World means having a conversation; somebody says something,
...
conversation.</p> <p>The rules help shape the conversation of play. While the GM and the players
...
conversation.</p> <p>Like any conversation, the time you spend listening is just as important as
...
questions, and build on each other’s contributions.</p> <p>This chapter is all about how to play Dungeon World. Here, you’ll find
...
like those for dealing with damage and hit points.</p> <h3 id="ability-scores-and-modifiers"><a aria-hidden="true" tabindex="-1" href="#ability-scores-and-modifiers"><span class="icon icon-link"></span></a>Ability Scores and Modifiers</h3> <p>Many of the rules discussed in this chapter rely on a player character’s
...
18 is the peak of mortal ability.</p> <p>Each ability has a modifier associated with it that is used when rolling with
...
from the current ability score.</p> <h2 id="making-moves"><a aria-hidden="true" tabindex="-1" href="#making-moves"><span class="icon icon-link"></span></a>Making Moves</h2> <p>The most basic unit of rules in Dungeon World is the move. A move looks like
this:</p> <p>When you <strong>attack an enemy in melee</strong>, roll+Str. ✴On a 10+, you deal your
...
your damage to the enemy and the enemy makes an attack against you.</p> <p>Moves are rules that tell you when they trigger and what effect they have. A
...
differing fictional effects based on the outcome of the roll.</p> <p>When a player describes their character doing something that triggers a move,
that move happens and its rules apply. If the move requires a roll, its
description will tell you what dice to roll and how to read their results.</p> <p>A character can’t take the fictional action that triggers a move without that
...
hand.</p> <p>Everyone at the table should listen for when moves apply. If it’s ever unclear
...
requires.</p> <p>The GM’s monsters, NPCs, and other assorted beasties also have moves, but they
work differently.</p> <h3 id="moves-and-dice"><a aria-hidden="true" tabindex="-1" href="#moves-and-dice"><span class="icon icon-link"></span></a>Moves and Dice</h3> <p>Most moves include the phrase “roll+x” where “x” is one of your character’s
...
value to your roll instead of an ability modifier.</p> <p>I’m making a move that asks me to roll+STR and my STR modifier is +1. I rolled
two six-sided dice, got a one and a four. My total is six.</p> <p>The results always fall into three basic categories. A total of 10 or higher
...
mark XP.</p> <p>Each move will tell you what happens on a 10+ and a 7–9. Most moves won’t say
what happens on a 6-, that’s up to the GM but you also always mark XP.</p> <p>Damage rolls work a little differently. They use different dice depending on
who or what is dealing damage.</p> <h3 id="moves-and-equipment"><a aria-hidden="true" tabindex="-1" href="#moves-and-equipment"><span class="icon icon-link"></span></a>Moves and Equipment</h3> <p>The most important role of a character’s equipment is to help describe the
...
purposes of triggering the move.</p> <p>Likewise, sometimes equipment will avoid triggering a move. Climbing a sheer
icy cliff is usually defying danger, but with a good set of climbing gear you
might be able to avoid the imminent danger or calamity that triggers the move.</p> <p>Weapons are particularly likely to modify what moves you can trigger. A
...
much harder time bringing it to bear on such a close foe.</p> <p>Items and gear of every sort have tags. Tags are terms to describe things.
...
wrong or cause complications when you fail a roll.</p> <h3 id="the-effects-of-moves"><a aria-hidden="true" tabindex="-1" href="#the-effects-of-moves"><span class="icon icon-link"></span></a>The Effects of Moves</h3> <p>The effects of moves are always about the fictional world the characters
inhabit. A 10+ on hack and slash doesn’t just mean the mechanical effects, it
means you successfully attacked something and did some type of harm to it.</p> <p>Once you’ve figured out what the effects of the move are, apply them to the
fiction and go back to the conversation. Always return to what’s going on in
the game.</p> <p>Some moves have immediate mechanical effects, like dealing damage or giving
...
describing the effects of the move.</p> <h4 id="some-moves"><a aria-hidden="true" tabindex="-1" href="#some-moves"><span class="icon icon-link"></span></a>Some Moves…</h4> <p>…Use the phrase “deal damage.” Dealing damage means you roll the damage dice
...
weapons with the right training or an interesting situation</p> <p>…Say “take +1 forward.” That means to take +1 to your next move roll (not
...
not any other move.</p> <p>…Say “take +1 ongoing.” That means to take +1 to all move rolls (not
...
spell” or “until you atone to your deity.”</p> <p>…Give you “hold.” Hold is currency that allows you to make some choices later
...
or vice versa, for example.</p> <p>…Present a choice. The choice you make, like all move effects, dictates things
...
they have enough advantage that they can stay safe or push their luck.</p> <p>…Give you a chance to say something about your character and their history.
...
help, damage is healed and HP is restored.</p> <h3 id="hp"><a aria-hidden="true" tabindex="-1" href="#hp"><span class="icon icon-link"></span></a>HP</h3> <p>A character’s HP is a measure of their stamina, endurance, and health. More HP
means the character can fight longer and endure more trauma before facing
Death’s cold stare.</p> <p>Your class tells your maximum HP. Your Constitution (the ability, not the
...
maximum HP stays the same.</p> <h3 id="damage"><a aria-hidden="true" tabindex="-1" href="#damage"><span class="icon icon-link"></span></a>Damage</h3> <p>When a character takes damage they subtract the damage dealt from their
...
character below 0 HP.</p> <p>Damage is determined by the attacker. Player characters deal damage according
to their class, the weapon used, and the move they’ve made.</p> <p>If a move just says “deal damage” the character rolls their class’s damage
dice plus any bonuses or penalties from moves, weapons, or effects. If a move
specifies an amount of damage, use that in place of the class’s damage roll.</p> <p>Monsters roll damage as listed in their description. Use this damage any time
the monster takes direct action to hurt someone, even if they use a method
other than their normal attack.</p> <p>Other sources of damage—like being struck by a chunk of a collapsing tower, or
falling into a pit—are left to the GM based on these options:</p> <ul><li>It threatens bruises and scrapes at worst: d4 damage</li> <li>It’s likely to spill some blood, but nothing horrendous: d6 damage</li> <li>It might break some bones: d8 damage</li> <li>It could kill a common person: d10 damage</li></ul> <p>Add the <em>ignores armor</em> tag if the source of the damage is particularly large
or if the damage comes from magic or poison.</p> <p>Temporary or circumstantial armor works the same way as armor that you wear: 1
armor for partial cover, 2 armor for major cover.</p> <p>Damage is dealt based on the fiction. Moves that deal damage, like hack and
...
if it follows from the fiction.</p> <p>HP loss is often only part of the effect. If the harm is generalized, like
...
having your head chopped off is not HP damage, it’s just you being dead.</p> <h4 id="damage-from-multiple-creatures"><a aria-hidden="true" tabindex="-1" href="#damage-from-multiple-creatures"><span class="icon icon-link"></span></a>Damage From Multiple Creatures</h4> <p>It’s a brave monster that goes into battle alone. Most creatures fight with
...
damage at once.</p> <p>If multiple creatures attack at once roll the highest damage among them and
add +1 damage for each monster beyond the first.</p> <p>A goblin orkaster (d10+1 damage ignores armor) and three goblins (d6
...
acid leaks into the scratches left by the spears.</p> <h4 id="stun-damage"><a aria-hidden="true" tabindex="-1" href="#stun-damage"><span class="icon icon-link"></span></a>Stun Damage</h4> <p>Stun damage is non-lethal damage. A PC who takes stun damage is defying danger
...
around for a few seconds, fumbling blindly, etc.</p> <h4 id="adding-and-subtracting-damage"><a aria-hidden="true" tabindex="-1" href="#adding-and-subtracting-damage"><span class="icon icon-link"></span></a>Adding and Subtracting Damage</h4> <p>When a move tells you to add damage, you add that damage to the roll on the
dice. If it tells you to add some dice (like “+1d4 damage”) you roll that
extra dice and add its result to the total.</p> <p>The same goes for subtracting damage: you subtract the number from the total
...
minimum.</p> <h4 id="best-and-worst"><a aria-hidden="true" tabindex="-1" href="#best-and-worst"><span class="icon icon-link"></span></a>Best and Worst</h4> <p>Some monsters and moves have you roll damage multiple times and take the best
or worst result. In this case roll as normal but only apply the best (or
worst) result.</p> <p>If a monster rolls its d6 damage twice and takes the best result it’s written
b[2d6]. The b[] means “best.” Likewise, w[] means worst, so w[3d10]
means “roll a d10 for damage three times and use the worst result.”</p> <h3 id="healing"><a aria-hidden="true" tabindex="-1" href="#healing"><span class="icon icon-link"></span></a>Healing</h3> <p>There are two sources of healing in Dungeon World: medical aid and the passage
of time.</p> <p>Medical aid, both magical and mundane, heals damage according to the move or
item used. Some moves may fully replenish HP while others heal just enough to
keep someone standing through a fight.</p> <p>Whenever a character spends some time resting without doing anything to
...
in civilization.</p> <p>No matter the source of the healing a character’s HP can never increase above
their maximum.</p> <h3 id="death"><a aria-hidden="true" tabindex="-1" href="#death"><span class="icon icon-link"></span></a>Death</h3> <p>Death stalks the edges of every battle. A character who is reduced to 0 HP
immediately takes his Last Breath. Death comes for commoner and king alike—no
stat is added to the Last Breath roll.</p> <p>No one knows what lies beyond the Black Gates of Death, but it is said that
many secrets of the mortal plane are laid bare in the land of Death’s
dominion. When you die, you might just see them.</p> <p>Death offers bargains to some, from the simple to the costly. Death is
...
cannot be predicted.</p> <p>Depending on the outcome of the Last Breath the character may become stable. A
...
and return to face Death.</p> <h4 id="after-death"><a aria-hidden="true" tabindex="-1" href="#after-death"><span class="icon icon-link"></span></a>After Death</h4> <p>Being an adventurer isn’t easy—it’s cold nights in the wild and sharp swords
...
to conquer. Even dead adventurers can rise again.</p> <p>If your character dies you can ask the GM and the other players to try and
...
has a say.</p> <p>No matter the prospects of resurrection for now you make a new character.
...
character, switching between them as you please (so long as it makes sense).</p> <p>GM, when you tell the players what needs to be done to bring their comrade
...
when you’re sick.</p> <p>You can only have each debility once. If you’re already Sick and something
makes you Sick you just ignore it.</p> <p>Debilities are harder to heal than HP. Some high level magic can do it, sure,
...
something happens that would remove a debility, that debility is gone.</p> <p>Debilities don’t replace descriptions and using the established fiction. When
...
anonymous fever picked up from a filthy rat.</p> <h2 id="magic"><a aria-hidden="true" tabindex="-1" href="#magic"><span class="icon icon-link"></span></a>Magic</h2> <p>Dungeon World is a fantastic place: there’s more to it than mud, blood, and
...
beyond.</p> <p>Magic means many things. The druid’s ability to take the shape of an animal is
magic, as are the practiced effects of the wizard and the divine blessings of
the cleric. Any ability that goes beyond the physically possible is magical.</p> <h3 id="spells"><a aria-hidden="true" tabindex="-1" href="#spells"><span class="icon icon-link"></span></a>Spells</h3> <p>Some classes, like the cleric and the wizard have access to spells: specific
magical effects that are the benefit of divine servitude or severe study. Each
spell has a name, tags, a level, and an effect.</p> <p>The basic flow of magic is to know, prepare, cast, and forget a spell.</p> <p>Known spells are those a spellcaster has mastered enough to prepare. The
...
spells in their spellbook.</p> <p>Even if a spellcaster knows a spell, they must have it prepared before they
...
spell is ready to be cast.</p> <p>Casting a spell involves calling on a deity, chanting, waving ones hands,
...
something ends it.</p> <p>One option on a 7–9 result is to have the spell revoked or forgotten. A spell
...
may choose the same spell again.</p> <h2 id="character-change"><a aria-hidden="true" tabindex="-1" href="#character-change"><span class="icon icon-link"></span></a>Character Change</h2> <p>Dungeon World is ever-changing. The characters change, too. As their
...
mightier deeds.</p> <p>Advancement, like everything else in Dungeon World, is both prescriptive and
...
to match.</p> <p>This isn’t a benefit or detriment to the players or the GM; it’s not an excuse
to gain more powers or take them away. It’s just a reflection of life in
Dungeon World.</p> <p>Avon, despite being a wizard, has risen to the notice of Lenoral, the deity of
...
and gain boons like a cleric.</p> <p>Gregor offers his signature weapon, an axe whose green steel is tempered in
...
he recover it he’ll have access to its benefits again.</p> <p>Descriptive changes only happen when the character has clearly gained access
to an ability. It’s not up to any one player to decide this—if you think a
character qualifies for a new ability, discuss it as a group.</p> <h3 id="level-up"><a aria-hidden="true" tabindex="-1" href="#level-up"><span class="icon icon-link"></span></a>Level Up</h3> <p>As you play Dungeon World, you’ll be doing three things most of all:
...
you play.</p> <p>When your characters have safety and a chance to rest, they’ll be able to make
the Level Up move to level up and gain new moves.</p> <h4 id="multiclass-moves"><a aria-hidden="true" tabindex="-1" href="#multiclass-moves"><span class="icon icon-link"></span></a>Multiclass Moves</h4> <p>The multiclass moves allow you to gain moves from another class. You get to
...
first gained a move from that class.</p> <h4 id="requires-and-replaces"><a aria-hidden="true" tabindex="-1" href="#requires-and-replaces"><span class="icon icon-link"></span></a>Requires and Replaces</h4> <p>Some moves that you gain at higher levels depend on other moves. If another
move is listed along with the word Requires or Replaces you can only gain the
new move if you have the listed move.</p> <p>A move that requires another move can only be taken if you have the move it
requires already. You then have both moves and they both apply.</p> <p>A move that replaces another move can only be taken if you have the move it
...
armor instead.</p> <h4 id="beyond-10th-level"><a aria-hidden="true" tabindex="-1" href="#beyond-10th-level"><span class="icon icon-link"></span></a>Beyond 10th Level</h4> <p>Once you’ve reached 10th level things change a little. When you have enough XP
to go to 11th level instead you choose one of these:</p> <ul><li>Retire to safety</li> <li>Take on an apprentice</li> <li>Change entirely to a new class</li></ul> <p>If you retire you create a new character to play instead and work with the GM
...
class.</p> <h2 id="bonds"><a aria-hidden="true" tabindex="-1" href="#bonds"><span class="icon icon-link"></span></a>Bonds</h2> <p>Bonds are what make you a party of adventurers, not just a random assortment
of people. They’re the feelings, thoughts, and shared history that tie you
together. You will always have at least one bond, and you’ll often have more.</p> <p>Each bond is a simple statement that relates your character to another player
character. Your class gives you a few to start with, you’ll replace your
starting bonds and gain new ones through play.</p> <h3 id="resolving-bonds"><a aria-hidden="true" tabindex="-1" href="#resolving-bonds"><span class="icon icon-link"></span></a>Resolving Bonds</h3> <p>At the end of each session you may resolve one bond. Resolution of a bond
...
you resolve a bond, you get to mark XP.</p> <p>A bond is resolved when it no longer describes how you relate to that person.
...
anymore” the bond is at a good place to resolve.</p> <p>If you have a blank bond left over from character creation you can assign a
...
future.</p> <h3 id="writing-new-bonds"><a aria-hidden="true" tabindex="-1" href="#writing-new-bonds"><span class="icon icon-link"></span></a>Writing New Bonds</h3> <p>You write a new bond whenever you resolve an old one. Your new bond may be
with the same character, but it doesn’t have to be.</p> <p>When you write a new bond choose another character. Pick something relevant to
...
with something like this:</p> <p>Mouse’s quick thinking saved me from the white dragon we faced. I owe her a
boon.</p> <p>Avon proved himself a coward in the dungeons of Xax’takar. He is a dangerous
liability to the party and must be watched.</p> <p>Valeria’s kindness to the Gnomes of the Vale has swayed my heart, I will prove
to her I am not the callous fiend she thinks I am.</p> <p>Xotoq won the Bone-and-Whispers Axe through trickery! It will be mine, I
swear it.</p> <p>These new bonds are just like the old ones—use them, resolve them, replace
them.</p> <h2 id="alignment"><a aria-hidden="true" tabindex="-1" href="#alignment"><span class="icon icon-link"></span></a>Alignment</h2> <p>Alignment is your character’s way of thinking and moral compass. For the
...
alignment, be they an elf, a human, or some other, stranger thing.</p> <p>The alignments are Good, Lawful, Neutral, Chaotic, and Evil. Each one shows an
aspiration to be a different type of person.</p> <p>Lawful creatures aspire to impose order on the world, either for their own
...
the expense of others.</p> <p>A Neutral creature looks out for itself so long as that doesn’t jeopardize
someone else’s well-being. Neutral characters are content to live their lives
and pursue their own goals and let others do the same.</p> <p>Most creatures are Neutral. They take no particular pleasure in harming
others, but will do it if it is justified by their situation. Those that put
an ideal—be it Law, Chaos, Good, or Evil—above themselves are harder to find.</p> <p>Even two creatures of the same alignment can come into conflict. Aspiring to
help others does not grant infallibility, two Good creatures may fight and die
over two different views of how to do right.</p> <h3 id="changing-alignment"><a aria-hidden="true" tabindex="-1" href="#changing-alignment"><span class="icon icon-link"></span></a>Changing Alignment</h3> <p>Alignment can, and will, change. Usually such a change comes about as a
...
must have a reason for the change which they can explain to the other players.</p> <p>In some cases a player character may switch alignment moves while still
...
important.</p> <h4 id="lawful"><a aria-hidden="true" tabindex="-1" href="#lawful"><span class="icon icon-link"></span></a>Lawful</h4> <ul><li>Uphold the letter of the law over the spirit</li> <li>Fulfill a promise of import</li> <li>Bring someone to justice</li> <li>Choose honor over personal gain</li> <li>Return treasure to its rightful owner</li></ul> <h4 id="good"><a aria-hidden="true" tabindex="-1" href="#good"><span class="icon icon-link"></span></a>Good</h4> <ul><li>Ignore danger to aid another</li> <li>Lead others into righteous battle</li> <li>Give up powers or riches for the greater good</li> <li>Reveal a dangerous lie</li> <li>Show mercy</li></ul> <h4 id="neutral"><a aria-hidden="true" tabindex="-1" href="#neutral"><span class="icon icon-link"></span></a>Neutral</h4> <ul><li>Make an ally of someone powerful</li> <li>Defeat a personally important foe</li> <li>Learn a secret about an enemy</li> <li>Uncover a hidden truth</li></ul> <h4 id="chaotic"><a aria-hidden="true" tabindex="-1" href="#chaotic"><span class="icon icon-link"></span></a>Chaotic</h4> <ul><li>Reveal corruption</li> <li>Break an unjust law to benefit another</li> <li>Defeat a tyrant</li> <li>Reveal hypocrisy</li></ul> <h4 id="evil"><a aria-hidden="true" tabindex="-1" href="#evil"><span class="icon icon-link"></span></a>Evil</h4> <ul><li>Take advantage of someone’s trust</li> <li>Cause suffering for its own sake</li> <li>Destroy something beautiful</li> <li>Upset the rightful order</li> <li>Harm an innocent</li></ul> <h2 id="hirelings"><a aria-hidden="true" tabindex="-1" href="#hirelings"><span class="icon icon-link"></span></a>Hirelings</h2> <p>Hirelings are those sorry souls that—for money, glory, or stranger
needs—venture along with adventurers into the gloom and danger. They are the
foolhardy that seek to make their name as adventurers.</p> <p>Hirelings serve a few purposes. To the characters, they’re the help. They lend
...
the depths of the earth or the far reaches of the planes.</p> <p>Hirelings are not heroes. A hireling may become a hero, as a replacement
...
defined by their <strong>Skill</strong> (or Skills) a <strong>Cost</strong> and a <strong>Loyalty</strong> score.</p> <p>A hireling’s skill is a special benefit they provide to the players. Most
...
highest skill.</p> <p>Skills don’t limit what a hireling can do, they just provide mechanics for a
...
something that is clearly beyond their abilities is asking the GM for trouble.</p> <p>No hireling works for free. The hireling’s cost is what it takes to keep them
with the player characters. If the hireling’s cost isn’t paid regularly
(usually once a session) they’re liable to quit or turn on their employers.</p> <p>When hirelings are in play, the players may have to make the Order Hirelings
move. The move uses the loyalty of the hireling that triggered the move:</p> <p>Hirelings do what you tell them to, so long as it isn’t obviously dangerous,
degrading, or stupid, and their cost is met. <strong>When a hireling find themselves
in a dangerous, degrading, or just flat-out crazy situation due to your
orders</strong> roll+loyalty. On a 10+ they stand firm and carry out the order. On a
7–9 they do it for now, but come back with serious demands later. Meet them or
the hireling quits on the worst terms.</p> <h2 id="making-a-hireling"><a aria-hidden="true" tabindex="-1" href="#making-a-hireling"><span class="icon icon-link"></span></a>Making a Hireling</h2> <p>Hirelings are easy to make on the fly. When someone enters the players’ employ
note down their name and what cost they’ve agreed to as well as any skills
they may have.</p> <p>Start with a number based on where the hireling was found. Hirelings in
...
you’re done.</p> <p>A hireling’s stats, especially their loyalty, may change during play as a
...
lower the hireling’s loyalty.</p> <h3 id="costs"><a aria-hidden="true" tabindex="-1" href="#costs"><span class="icon icon-link"></span></a>Costs</h3> <ul><li>The Thrill of Victory</li> <li>Money</li> <li>Uncovered Knowledge</li> <li>Fame and Glory</li> <li>Debauchery</li> <li>Good Accomplished</li></ul> <h3 id="skills"><a aria-hidden="true" tabindex="-1" href="#skills"><span class="icon icon-link"></span></a>Skills</h3> <p>When you make a hireling, distribute points among one or more of these skills.</p> <h4 id="adept"><a aria-hidden="true" tabindex="-1" href="#adept"><span class="icon icon-link"></span></a>Adept</h4> <p>An adept has at least apprenticed to an arcane expert, but is not powerful in
their own right. They’re the grad students of the arcane world.</p> <p><em>Arcane Assistance</em>—When an adept aids in the casting of a spell of lower
...
negative effects of the casting are focused on the adept first.</p> <h4 id="burglar"><a aria-hidden="true" tabindex="-1" href="#burglar"><span class="icon icon-link"></span></a>Burglar</h4> <p>Burglars are skilled in a variety of areas, most of them illicit or dangerous.
They are good with devices and traps, but not too helpful in the field of
battle.</p> <p><em>Experimental Trap Disarming</em>—When a burglar leads the way they can detect
...
near the trap, the burglar can disarm it by the time camp is broken.</p> <h4 id="minstrel"><a aria-hidden="true" tabindex="-1" href="#minstrel"><span class="icon icon-link"></span></a>Minstrel</h4> <p>When a smiling face is needed to smooth things over or negotiate a deal a
minstrel is always happy to lend their services for the proper price.</p> <p><em>A Hero’s Welcome</em>—When you enter a place of food, drink, or entertainment
...
all prices in town.</p> <h4 id="priest"><a aria-hidden="true" tabindex="-1" href="#priest"><span class="icon icon-link"></span></a>Priest</h4> <p>Priests are the lower ranking clergy of a religion, performing minor offices
and regular sacraments. While not granted spells themselves, they are able to
call upon their deity for minor aid.</p> <p><em>Ministry</em>—When you make camp with a priest if you would normally heal you
heal +skill HP.</p> <p><em>First Aid</em>—When a priest staunches your wounds heal 2×skill HP. You take -1
forward as their healing is painful and distracting.</p> <h4 id="protector"><a aria-hidden="true" tabindex="-1" href="#protector"><span class="icon icon-link"></span></a>Protector</h4> <p>A protector stands between their employer and the blades, fangs, teeth, and
spells that would harm them.</p> <p><em>Sentry</em>—When a protector stands between you and an attack you increase your
armor against that attack by the defender’s skill, then reduce their skill by
1 until they receive healing or have time to mend.</p> <p><em>Intervene</em>—When a protector helps you defy danger you may opt to take +1 from
their aid. If you do you cannot get a 10+ result, a 10+ instead counts as a
7–9.</p> <h4 id="tracker"><a aria-hidden="true" tabindex="-1" href="#tracker"><span class="icon icon-link"></span></a>Tracker</h4> <p>Trackers know the secrets of following a trail, but they don’t have the
experience with strange creatures and exotic locales that make for a great
hunter.</p> <p><em>Track</em>—When a tracker is given time to study a trail while Making Camp, when
camp is broken they can follow the trail to the next major change in terrain,
travel, or weather.</p> <p><em>Guide</em>—When a tracker leads the way you automatically succeed on any Perilous
Journey of a distance (in rations) lower than the tracker’s skill.</p> <h4 id="warrior"><a aria-hidden="true" tabindex="-1" href="#warrior"><span class="icon icon-link"></span></a>Warrior</h4> <p>Warriors are not masters of combat, but they are handy with a weapon.</p> <p><em>Man-at-arms</em>—When you deal damage while a warrior aids you add their skill to
the damage done. If your attack results in consequences (like a counter
attack) the man-at-arms takes the brunt of it.</p> <h2 id="the-adventurers-life"><a aria-hidden="true" tabindex="-1" href="#the-adventurers-life"><span class="icon icon-link"></span></a>The Adventurer’s Life</h2> <p>Now you know the basics. It’s time you found out what the adventurer’s life is
...
gold coin.</p> <h3 id="dungeons"><a aria-hidden="true" tabindex="-1" href="#dungeons"><span class="icon icon-link"></span></a>Dungeons</h3> <p>As an adventurer you’ll spend a lot of time in dungeons. The word “dungeon”
...
foundations of the world.</p> <p>The most important thing to remember when you’re in a dungeon is that it’s a
...
count on anything in a dungeon.</p> <p>Since dungeons are living places you’d better prepare for the long haul.
...
traps…</p> <p>Speaking of traps—keep your eyes open for them, too. The thief is your best
...
would.</p> <p>When you’re unlucky enough to trigger a trap you might have a chance to get
...
before you even know it’s sprung.</p> <p>That sounds grim, sure, but it’s not as bad as all that. You’ve got steel,
skills, and spells. If you stick together and keep your wits you’ll make it
out alive. Probably.</p> <h3 id="monsters"><a aria-hidden="true" tabindex="-1" href="#monsters"><span class="icon icon-link"></span></a>Monsters</h3> <p>The beasts and worse that fill dungeons? We call them monsters.</p> <p>Not all of them appear monstrous. Sometimes it’s just a guy in some armor—no
horns, flames, or wings, nothing. But when that guy wants to kill you, well,
he’s as much a monster as the rest.</p> <p>Some don’t even need arms and armor. A wily warlock or nefarious noble can
...
reason they don’t need a shell of steel.</p> <p>When it comes to fighting monsters, it’s an even bet: your life versus theirs.
...
your advantages, and you’ll live long enough to enjoy the spoils.</p> <p>Fights often mean triggering moves like hack and slash, defend, or volley.
...
and deal your damage.</p> <p>Monsters generally fall into a few types. Humanoids are more or less like
...
again.</p> <p>When you find yourself in a fight with a monster you have a few different
...
might come in handy in a new way.</p> <h3 id="wilderness"><a aria-hidden="true" tabindex="-1" href="#wilderness"><span class="icon icon-link"></span></a>Wilderness</h3> <p>There’s dungeons, there’s civilization, and there’s all the stuff in-between:
the wilderness. The line between a forest and a dungeon is thinner than you
might think—have you ever been lost in the night and surrounded by wolves?</p> <p>Journeys by road are easy. When you’ve got a trail to follow and some modicum
of protection you’re not even making moves—you just consume some rations on
the way and make it to your destination. If it’s a perilous journey though…</p> <p>On a perilous journey you’ll need a trailblazer, a scout, and a quartermaster.
...
invitation for trouble.</p> <h3 id="friends-and-enemies"><a aria-hidden="true" tabindex="-1" href="#friends-and-enemies"><span class="icon icon-link"></span></a>Friends and Enemies</h3> <p>You’re an adventurer, so people will pay attention to you. Not all of that
...
the woodwork.</p> <p>Sure, you can get leverage on these people and parley them to get what you
...
want to make friends.</p> <p>Magic, though, that just might be mind control. The morality of it’s debatable
but you can bend someone to your will if you don’t mind tossing their free
will in the corner.</p> <p>It’s worth keeping track of who’s got your back and who’d sooner stab you in
it. The GM will be doing the same, and the worst enemy is the one you don’t
know. You’re not the only ones in Dungeon World with grand designs.</p> <p>While you live the adventurer’s life, with no fixed address to give, other
...
thing indeed.</p> <p>Keep in mind that not all power is physical. Even if you could take down King
Arlon in a fight you’ll just be inviting retribution from his kin, allies, and
court. Station is its own kind of power apart from magic and might.</p> <h3 id="the-world"><a aria-hidden="true" tabindex="-1" href="#the-world"><span class="icon icon-link"></span></a>The World</h3> <p>You’re an adventurer; you’re a big deal. But there are other forces at work
...
take over the city. Do you really want to find out?</p> <p>A world in motion is a world waiting to be changed. Your choices of who to
...
you and the world you live in.</p>`,1);function i(e){var i=r();n(460),t(e,i)}export{i as default};