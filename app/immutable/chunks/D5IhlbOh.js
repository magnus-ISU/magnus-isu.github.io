import"./Bg9kRutz.js";import"./69_IOA4Y.js";import{n as o}from"./CUSK-jMp.js";import{a,t as n}from"./DuK_Zf15.js";var i=n(`<h1 id="folk-of-the-realm"><a aria-hidden="true" tabindex="-1" href="#folk-of-the-realm"><span class="icon icon-link"></span></a>Folk of the Realm</h1> <p>Acolyte</p> <p>“Can’t all be the High Priest, they said. Can’t all wield the White Spire,
...
bruised knees and dishpan hands. If only I’d been a cleric, instead.” <em>Instinct</em>: To serve dutifully</p> <ul><li>Follow dogma</li> <li>Offer eternal reward for mortal deeds</li></ul> <p>Adventurer Horde, Intelligent</p> <p>Sword (d6 damage) 3 HP 1 Armor</p> <p>Close</p> <p><strong>Special Qualities:</strong> Endless enthusiasm</p> <p>“Scum of the earth, they are. A troupe of armored men and women come
...
hobos. Oh, wait, you’re an adventurer? I take it all back.” <em>Instinct</em>: To
adventure or die trying</p> <ul><li>Go on a fool’s errand</li> <li>Act impulsively</li> <li>Share tales of past exploits</li></ul> <p>Bandit Horde, Intelligent, Organized</p> <p>Dirk (d6 damage) 3 HP 1 Armor</p> <p>Close</p> <p>Desperation is the watchword of banditry. When times are tough, what else is
...
baser lusts? Anyway—it’s this or starve, sometimes. <em>Instinct</em>: To rob</p> <ul><li>Steal something</li> <li>Demand tribute</li></ul> <p>Bandit King Solitary, Intelligent, Organized</p> <p>Trusty knife (b[2d10] damage) 12 HP 1 Armor</p> <p>Close</p> <p>Better to rule in hell than serve in heaven. <em>Instinct</em>: To lead</p> <ul><li>Make a demand</li> <li>Extort</li> <li>Topple power</li></ul> <p>Fool</p> <p>There’s not but one person in all the King’s court allowed to speak the truth.
...
red-faced and you’d just as soon drown him in a cesspit. <em>Instinct</em>: To mock</p> <ul><li>Expose injustice</li> <li>Play a trick</li></ul> <p>Guardsman Group, Intelligent, Organized</p> <p>Spear (d8 damage) 6 HP 1 Armor</p> <p>Close, Reach</p> <p>Noble protector or merely drunken lout, it often makes no difference to these
...
drunkenly insulting your mother, hmm? <em>Instinct</em>: To do as ordered</p> <ul><li>Uphold the law</li> <li>Make a profit</li></ul> <p>Halfling Thief Solitary, Small, Intelligent, Stealthy, Devious</p> <p>Dagger (w[2d8] damage) 12 HP 1 Armor</p> <p>Close</p> <p>It would be foolish, now, to draw conclusions about folks just because they
...
you deserved it. <em>Instinct</em>: To live a life of stolen luxury</p> <ul><li>Steal</li> <li>Put on the appearance of friendship</li></ul> <p>Hedge Wizard Magical</p> <p>Not all those who wield the arcane arts are adventuring wizards. Nor
...
can find his rotten hut in the swamp and pay the price he asks. <em>Instinct</em>: To
learn</p> <ul><li>Cast almost the right spell (for a price)</li> <li>Make deals beyond their ken</li></ul> <p>High Priest</p> <p>Respected by all who gaze upon them, the high priests and abbesses of Dungeon
...
wide berth as they pass in their shining robes. <em>Instinct</em>: To lead</p> <ul><li>Set down divine law</li> <li>Reveal divine secrets</li> <li>Commission divine undertakings</li></ul> <p>Hunter Group, Intelligent</p> <p>Ragged bow (d6 damage) 6 HP 1 Armor</p> <p>Near, Far</p> <p>The wilds are home to more than just beasts of horn and scale. There are men
...
Solemn, somber and quiet, they find a sort of peace in the wild. <em>Instinct</em>:
To survive</p> <ul><li>Bring back news from the wilds</li> <li>Slay a beast</li></ul> <p>Knight Solitary, Intelligent, Organized, Cautious</p> <p>Sword (b[2d10] damage) 12 HP 4 Armor</p> <p>Close</p> <p>What youngster doesn’t cling to the rail at the mighty joust, blinded by the
...
see her. A knight means something. <em>Instinct</em>: To live by a code</p> <ul><li>Make a moral stand</li> <li>Lead soldiers into battle</li></ul> <p>Merchant</p> <p>“Ten foot poles. Get your ten foot poles, here. Torches, bright and hot.
Mules, too—stubborn but immaculately bred. Need a linen sack, do you? Right
over here! Come and get your ten foot poles!” <em>Instinct</em>: To profit</p> <ul><li>Propose a business venture</li> <li>Offer a “deal”</li></ul> <p>Noble</p> <p>Are they granted their place by the gods, perhaps? Is that why they’re able to
...
in gold. It’s a tough life. <em>Instinct</em>: To rule</p> <ul><li>Issue an order</li> <li>Offer a reward</li></ul> <p>Peasant</p> <p>Covered in muck, downtrodden at the bottom of the great chain of being, we all
...
sense you had, adventurer. <em>Instinct</em>: To get by</p> <ul><li>Plead for help</li> <li>Offer a simple reward and gratitude</li></ul> <p>Rebel Horde, Intelligent, Organized</p> <p>Axe (d6 damage) 3 HP 1 Armor</p> <p>Close</p> <p>In the countryside they’d be called outlaw and driven off or killed. The city,
...
common fear amongst the nobles of Dungeon World. These men and women are why. <em>Instinct</em>: To upset order</p> <ul><li>Die for a cause</li> <li>Inspire others</li></ul> <p>Soldier Horde, Intelligent, Organized</p> <p>Spear (d6 damage) 3 HP 1 Armor</p> <p>Close, Reach</p> <p>For a commoner with a strong arm, sometimes it’s this or be a bandit. It’s
...
is it they say? A handful of soldiers beats a mouthful of arguments. <em>Instinct</em>: To fight</p> <ul><li>March into battle</li> <li>Fight as one</li></ul> <p>Spy</p> <p>Beloved of kings but never truly trusted. Mysterious, secretive and alluring,
...
folks’ minds without them ever knowing it. How can we trust you? <em>Instinct</em>:
To infiltrate</p> <ul><li>Report the truth</li> <li>Double cross</li></ul> <p>Tinkerer</p> <p>It’s said that if you see a tinker on the road and you don’t offer him a swig
...
maybe they’re just antisocial peddlers. You never know, right? <em>Instinct</em>: To
create</p> <ul><li>Offer an oddity at a price</li> <li>Spin tales of great danger and reward in far-off lands</li></ul>`,1);function d(e){var t=i();o(146),a(e,t)}export{d as default};
