var e=`# The Dashing Hero

There are heroes who pray, heroes who study, and heroes who train. And then there's you — the one who shows up at the last second, swings from the chandelier, disarms the villain with a flick of the wrist, and kisses the love interest before the dust settles.

You live for the thrill. The impossible leap, the witty retort, the duel on the crumbling bridge. Your blade is quick, your smile is quicker, and trouble follows you like a lovesick puppy. But that's fine. You wouldn't have it any other way.

After all, what's the point of saving the world if you can't look good doing it?
...
### Anything You Can Do...
You are a quick student, and a bit of a showboat. When you **Make Camp**, choose one move another player knows and hold Showoff equal to the number of bonds you have with that player. You can spend 1 Showoff to use that move. When you **Make Camp**, lose any remaining Showoff. [3 Charges]
...
### Hero of the People
When you **aid a person in need**, gain 1 karma. You can spend 1 karma at any time to gain leverage against anyone related to someone you've helped. You may also spend 1 karma to snub a person in need without them thinking any less of you.

### In the Nick of Time
When you **need to get somewhere quickly**, roll+DEX. On a 10+, you get where you need to be the moment before you need to be there. On a 7-9, that, and you draw unwanted attention on your way there.
...
Your skill is beyond compare. When you **Make Camp**, choose one move another player knows, and hold Showoff equal to the number of bonds you have with that player. When you **use the chosen move**, you can spend 1 Showoff to take +1 to your roll. When you **Make Camp**, lose any remaining Showoff. [3 Charges]

### Just a Flesh Wound
When you **take a truly grievous wound**, roll+CON. On a 10+, choose two. On a 7-9, choose one:
- Take +1 forward against the cause of your injury
- Take +2 forward to a stat you have a debility in
- Take half damage
