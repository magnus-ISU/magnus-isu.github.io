...
Roll+Str.</p> <p>Jarl: I got an 11. It says here that I have a choice. Fear is for the weak, let those goblins come!</p> <p>GM: You smash your hammer into the nearest goblin and are rewarded by the satisfying sound of the crunching of his bones. That and a knife wound as the goblin counterattacks. He deals 4 damage to you. What do you do?</p> <p>GM: Cadeus, from the shadows, you’ve got the drop on those orc warriors.</p> <p>Cadeus: I leap out and bring my sword down in a sweeping arc! Like this! Yeeeah!</p> <p>GM: Well, they weren’t expecting that, they’re caught totally off guard and you slice into one. Roll damage.</p> <p>Cadeus: I deal 6 damage.</p> <p>GM: The orc collapses in a bloody heap! The second orc freezes and then he’s grinning at you with that horrible tusked mouth, raising his signal horn from his belt! What do you do?</p> <p>GM: Bartleby, you’ve got Finbar the Magnificent, mightiest duelist in the land, completely disarmed and at sword point.</p> <p>Bartleby: I won’t let you betray me again, Finbar! I run him through.</p> <p>GM: Well, okay, that’s a hack and slash, roll+Str.</p> <p>Bartleby: If you say so… I got a 7.</p> <p>GM: Okay, you run him through because he can’t even defend himself and… umm, wait. You know what, he’s not in melee with you at all. He’s helpless, forget hack and slash, he’s toast. He slumps to the ground, coughing up blood but the sound of the guard alarm rings out. What do you do?</p></blockquote> <h2 id="volley"><a aria-hidden="true" tabindex="-1" href="#volley"><span class="icon icon-link"></span></a>Volley</h2> <p>When you <strong>take aim and shoot at an enemy at range</strong>, roll+Dex. ✴On a 10+, you
...
the move to get the results.</p> <blockquote><p>GM: Emory, as you climb up the side of the ravine you spy a cultist on a ledge nearby who evokes a frost spell and covers the side of the cliff with ice! If you want to keep climbing, you need to defy danger or you’ll fall.</p> <p>Emory: No way, I am too tough. I grit my teeth and dig my nails into the wall, climbing one hand at a time. I’m using Con, okay? I got an 8, though…</p> <p>GM: Hmm, well, I think the only way you can gain any traction, tough guy, is if you use your dagger to pull yourself up the last few feet. It’s going to be lodged in there until you have some time to pull it loose and there’s an angry spellcaster nearby.</p> <p>Emory: I can always get a new dagger when I get home. Time to finish this climb and that cultist.</p> <p>GM: The athach is swinging his burly third arm down at you, knobby fingers gripping a broken branch. What are you doing, Valeria?</p> <p>Valeria: So he wants to fight, huh? Let’s do it. I hack and slash him, swinging my sword at his legs.</p> <p>GM: Now hold on there, champ. He’s already got you at a disadvantage. You can jump into the fray but you’ll take that club head on unless you defy danger first.</p> <p>Valeria: Pfft, he’s no match for Valeria the Red! I leap aside like a leaf in the wind, then I start hacking and slashing.</p> <p>GM: Defy danger with your Dex, please and thank you.</p> <p>Octavia: I’ve had enough of this ogre, I’m going to drop my shield and swing my hammer in both hands. Hack and slash, right?</p> <p>GM: You drop your shield? That’s a bad idea–now you have to defy danger because the ogre is going to bash you.</p> <p>Octavia: Are you sure? Isn’t that what hack and slash is? Trading blows and stuff?</p> <p>GM: Yes, duh, of course. I need another cup of coffee–hack and slash it is, make your move!</p></blockquote> <h2 id="defend"><a aria-hidden="true" tabindex="-1" href="#defend"><span class="icon icon-link"></span></a>Defend</h2> <p>When you <strong>stand in defense of a person, item, or location</strong> under attack,
...
attacks and just trying to keep yourself safe.</p> <blockquote><p>GM: Avon, you begin weaving the spell to push the necromancer’s ghost back through the gates but the zombies are bearing down on you.</p> <p>Lux: Don’t worry, squishy Avon, I will save you. While Avon casts his spell, I swear to protect him—I slam my hammer on my shield and yell “If you want to stop him, you’ll have to come through me.” I’d like to defend Avon.</p> <p>GM: And with such gusto, too. Roll+Con.</p> <p>Lux: I get an 11, three hold, right?</p> <p>Avon: Better get ready to use it, Lux. I got an 8 on my spellcasting roll—I choose to put myself in danger.</p> <p>GM: Of course you do. The zombies are drawn by the magical disturbance, lurching toward you on the attack. Suddenly, you’re swarmed by them, they’re everywhere! What do you do?</p> <p>Avon: Squeak helplessly?</p> <p>Lux: I’m on it. I spend a point of my hold to redirect the attack to me—I shove Avon aside and let the full fury of my goodness spill out in waves, angering the undead. To be safe, I’m going to whip my hammer in an arc and deal my damage. I might as well use it all up and reduce the damage by half. My god protects us!</p> <p>GM: So, Hadrian, you’ve been defending Durga while she heals Willem, but now Willem is better. What do you do?</p> <p>Durga: I leap forward to drive back the troglodytes!</p> <p>Hadrian: I want to tangle with this crocodilian.</p> <p>GM: Okay, Durga, the trogs come at you with their clubs.</p> <p>Hadrian: No way, I still have hold left over, I want to spend it to redirect that attack to myself.</p> <p>GM: You two are spread out, now. How are you going to do that if you’re 20 yards away? You lost your hold when you attacked the croc, my friend.</p> <p>Hadrian: Yeah, I guess I’m not “standing in defense” anymore. Forget it, you’re on your own, Durga!</p></blockquote> <h2 id="spout-lore"><a aria-hidden="true" tabindex="-1" href="#spout-lore"><span class="icon icon-link"></span></a>Spout Lore</h2> <p>When you <strong>consult your accumulated knowledge about something</strong>, roll+Int. ✴On
...
to make them up on the spot. Always say what honesty demands.</p> <blockquote><p>Fenfaril: The floor was illusory? Damn those gnomes. Damn them straight to wherever gnomes go when they’re dead.</p> <p>GM: Heh, yep. You’re in a murky pit, and there’s a shadowy humanoid shape, mottled and eyeless, moving towards you, mumbling.</p> <p>Fenfaril: Mumbling shape, huh? What is that thing? Is it going to attack me? I’m sure I’ve read about them somewhere before, maybe at school?</p> <p>GM: Could be. Spout lore!</p> <p>Fenfaril: Bestow your knowledge upon me, brain. I rolled an 8.</p> <p>GM: Well, of course you know of these things—the name escapes you but you definitely remember a drawing of a creature like this. It was in a hallway, standing guard over something. You know there’s a trick to get it to let you pass but you can’t quite remember. Why not?</p> <p>Fenfaril: Obviously I was hungover that day. I was a terrible student. A trick, you say? Hmm…</p> <p>Vitus: I got a 10 on my spout lore about this gilded skull.</p> <p>GM: You’re pretty sure you recognize the metalwork of Dis, the living city.</p> <p>Vitus: …and? I did get a 10!</p> <p>GM: Right, of course. Well, you recognize a few glyphs specifically. They’re efreeti, marks of a fire spell, but they’re different, a kind of transmutation magic. I bet if you cast a spell into the skull, it’ll turn it into a fire spell.</p> <p>Vitus: Magic missiles of fire—hurrah!</p></blockquote> <h2 id="discern-realities"><a aria-hidden="true" tabindex="-1" href="#discern-realities"><span class="icon icon-link"></span></a>Discern Realities</h2> <p>When you <strong>closely study a situation or person</strong>, roll+Wis. ✴On a 10+, ask the
...
question with “Nothing, sorry.”</p> <blockquote><p>Omar: I don’t trust this room—I’m going to poke around a little. I take out my tools and start messing with stuff. I pull candlesticks and tap the walls with my hammer. My usual tricks.</p> <p>GM: Discern realities?</p> <p>Omar: Oh yes. I discern all the realities. I got a 12. I want to know “What here is not as it appears to be?”</p> <p>GM: Well, it’s obvious to you that the wall on the north side of the room has a hollow spot. The stones are newer and the mortar is fresher, probably a hidden alcove or passageway.</p> <p>Omar: I want to ask another one. “Who sealed the room.”</p> <p>GM: That’s not on the list, so I’m going pretend you asked “What happened here recently.” Looking at the stonework, you notice the wall actually bends out in places. The work is shoddy and awful—looks to you like the work of goblins. The only way it’d get bent out that way, though, is if there was something pushing it from within.</p> <p>Omar: So either the goblins blocked it from the other side, or there’s something in there that tried to get out.</p> <p>GM: Bingo.</p></blockquote> <h2 id="parley"><a aria-hidden="true" tabindex="-1" href="#parley"><span class="icon icon-link"></span></a>Parley</h2> <p>When you <strong>have leverage on a GM Character and manipulate them</strong>, roll+Cha.
