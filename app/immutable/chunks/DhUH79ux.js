import"./Bg9kRutz.js";import"./69_IOA4Y.js";import{n as a}from"./B4lZmn6G.js";import{a as o,t as n}from"./B5swcvNi.js";var i=n(`<h1 id="teaching-the-game"><a aria-hidden="true" tabindex="-1" href="#teaching-the-game"><span class="icon icon-link"></span></a>Teaching the Game</h1> <p>Since you’ve read this book it’s likely at some point you’ll be teaching the
...
found work well for teaching the game.</p> <h2 id="pitch-it"><a aria-hidden="true" tabindex="-1" href="#pitch-it"><span class="icon icon-link"></span></a>Pitch It</h2> <p>Before you play you’ll likely be explaining the game to your new players
...
like it.</p> <p>First and most importantly: put it in your own words. We can’t give you a
...
touch on.</p> <p>With first-time roleplayers it’s best to focus on what roleplaying means in
...
interesting ways.</p> <p>With folks who’ve played RPGs before, especially those who’ve played other
...
roleplayers often appreciate.</p> <p>No matter the audience, don’t just pitch Dungeon World, pitch the game you’re
...
honestly portray the game you intend to run.</p> <h2 id="present-the-classes"><a aria-hidden="true" tabindex="-1" href="#present-the-classes"><span class="icon icon-link"></span></a>Present the Classes</h2> <p>Once everybody’s on board for a game of Dungeon World and you’ve sat down to
...
about both what the class does and how that fits into the big picture.</p> <p>If anybody has questions about the rules, answer them, but for now focus on
...
move works.</p> <h2 id="create-characters"><a aria-hidden="true" tabindex="-1" href="#create-characters"><span class="icon icon-link"></span></a>Create Characters</h2> <p>Go through the character creation rules step by step. The process of creating
...
any wrong choices.</p> <p>Each player will encounter the rules that are important to their class. The
...
fiction, which is all the stats and tags reflect anyway.</p> <p>If your players are particularly worried about making their characters “right”
...
each. They’ll come up as needed.</p> <p>As the players introduce their characters and start setting bonds move from
...
estranged teacher or a simmering war).</p> <h3 id="start-play"><a aria-hidden="true" tabindex="-1" href="#start-play"><span class="icon icon-link"></span></a>Start Play</h3> <p>Start play by concretely describing the world around them. Keep it brief and
evocative, use plenty of details, and end with something that demands action.
Then ask them what they do.</p> <p>Ending with something that demands action is important. Don’t presume that new
players will already know what they want to do. Giving them something to react
to right away means you get straight to playing.</p> <p>Especially for new players make sure that the action they’re thrown into is
...
the complexity build.</p> <p>Even in a fight keep to simple monsters: things that bleed, don’t have too
...
armor or piercing or a certain monster, use it, but don’t lead with those.</p> <p>For new players make liberal use of your Show Signs of an Approaching Threat
...
what’s dangerous you can give them a little less warning.</p> <p>If you’re GMing for the first time focus on a few moves: Show Signs of an
...
like second nature.</p> <h3 id="continuing-play"><a aria-hidden="true" tabindex="-1" href="#continuing-play"><span class="icon icon-link"></span></a>Continuing Play</h3> <p>After an hour or two of play the players will likely have everything down. As
a first time GM you may take a bit longer to pick up all your moves, maybe a
session or two. Just roll with it.</p> <p>If you find yourself struggling in the first session consider it a pilot, like
...
scrap it and start something new.</p> <p>While Dungeon World works great for one-shots the longer cycles of levels and
...
and resolve them.</p>`,1);function p(e){var t=i();a(52),o(e,t)}export{p as default};
