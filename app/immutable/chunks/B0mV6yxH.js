import"./Bg9kRutz.js";import"./69_IOA4Y.js";import{n}from"./lTSu4Se7.js";import{a as r,t as o}from"./i5qHrSzT.js";var t=o(`<h1 id="thanks"><a aria-hidden="true" tabindex="-1" href="#thanks"><span class="icon icon-link"></span></a>Thanks</h1> <h1 id="influences"><a aria-hidden="true" tabindex="-1" href="#influences"><span class="icon icon-link"></span></a>Influences</h1> <p>If we have seen further it is by standing on the shoulders of giants. Hill
giants and stone giants mostly, but some frost giants and even a fire giant
one time. That got messy.</p> <p>By this point it’s probably pretty obvious that Vincent Baker’s Apocalypse
...
Moldvay, and Advanced Dungeons and Dragons were our references of choice.</p> <p>Our version of Alignment is closely related to Keys from Shadow of Yesterday
by Clinton R. Nixon as seen in John Harper’s Lady Blackbird.</p> <p>XP on a miss can be seen in a lot of designs—the version seen in Luke Crane’s
Burning Wheel was an inspiration, but this particular take on it comes by way
of John Harper and Paul Riddle’s The Regiment.</p> <p>Bonds are a perversion of Hx from Apocalypse World with a little bit of the
memories from Freemarket (by Luke Crane and Jared Sorensen) thrown in for
spice.</p> <p>Dungeon World wouldn’t exist without cross-pollination from many other
...
and several unpublished games by Jonathan Walton all were part of our process.</p> <p>The original idea to mash Apocalypse World and D&D together belongs to our
good friend Tony Dowler. He was gracious enough to let us build on his concept
and carry it through to the shape you see today.</p> <h1 id="tools"><a aria-hidden="true" tabindex="-1" href="#tools"><span class="icon icon-link"></span></a>Tools</h1> <p>Dungeon World was created in InDesign. The main fonts used are Adobe Minion
Pro, Newcomen, and Archemy.</p> <p>The original text was written entirely in XML to be imported into the book
...
versioning the files using Git and Github.</p> <p>We developed Dungeon World a bit like you develop software, so the Github bug
tracker and Dropbox were key tools in making the game a reality.</p> <h1 id="special-thanks"><a aria-hidden="true" tabindex="-1" href="#special-thanks"><span class="icon icon-link"></span></a>Special Thanks</h1> <p>Strasa Acimovic, Marshall Miller, Jason Morningstar, Simon Ward, Greg Cooksey,
Hamish Cameron, Kevin Weiser & the Walking Eye, Steve Segedy, John Harper,
Tony Dowler, Vincent Baker, Gary and Dave (of course).</p> <h1 id="contributors"><a aria-hidden="true" tabindex="-1" href="#contributors"><span class="icon icon-link"></span></a>Contributors</h1> <p>Tresi Arvizo, Jeremy Friesen, Alessandro “Adam” Gianni, Lee Reilly, Nathan
Black, Adam Blinkinsop, Matt Jett, Evan Silberman, Alexander Gude</p> <h1 id="guild-members"><a aria-hidden="true" tabindex="-1" href="#guild-members"><span class="icon icon-link"></span></a>Guild Members</h1> <p>Charles Boucher, PK Sullivan, Jeremy Friesen, Sara Williamson, Ara, Rob
...
Segedy, Strahinja “Stras” Acimovic, Jason Grabau</p> <h1 id="backers-bonded-to-the-book"><a aria-hidden="true" tabindex="-1" href="#backers-bonded-to-the-book"><span class="icon icon-link"></span></a>Backers Bonded to the Book</h1> <p>These brave Kickstarter backers have a bond with Dungeon World, and Dungeon
World has a bond with them:</p> <p>Simon Ward has seen what no other eyes could see. Matthew Sullivan-Barrett
...
play games, and he’s all out of bubblegum.</p> <h1 id="kickstarter-backers"><a aria-hidden="true" tabindex="-1" href="#kickstarter-backers"><span class="icon icon-link"></span></a>Kickstarter Backers</h1> <p>“Blue Hair Bob” Puckett, “Evil” Avi Zacherman, >B, a-bomb & g-girl, A.
...
Alfke, Jered Heeschen, Jeremiah Lee - @Trifecta_Games, Jeremiah McNichols,
...
Mansfield, Paul R. Plaisance, Paul Smith, Paul Stefko, Paul Towler, Paul Vogt</p> <ul><li>The Hopeless Gamer, Paul Watson, Paulo Segundo, Pedro Gómez-Esteban
...
Division, ZSP, östen petersson.</li></ul>`,1);function d(e){var a=t();n(48),r(e,a)}export{d as default};
