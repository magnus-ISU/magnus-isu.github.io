import"./Bg9kRutz.js";import"./69_IOA4Y.js";import{n as o}from"./B4lZmn6G.js";import{a,t as n}from"./B5swcvNi.js";var r=n(`<h1 id="adventure-conversion"><a aria-hidden="true" tabindex="-1" href="#adventure-conversion"><span class="icon icon-link"></span></a>Adventure Conversion</h1> <p>There isn’t always time for prep. People aren’t entirely committed to a
...
to run your favorite adventures using the rules in this book.</p> <h2 id="overview"><a aria-hidden="true" tabindex="-1" href="#overview"><span class="icon icon-link"></span></a>Overview</h2> <p>The first step in preparing an adventure for use with Dungeon World is reading
...
paying close attention to the four following topics as you go.</p> <ul><li>Maps</li> <li>Monsters</li> <li>Magic Items</li> <li>NPCs and Organizations</li></ul> <p>Flip through the adventure, make some notes as you go, but don’t feel you need
...
you and the players to discover as you go.</p> <p>When you’ve finished, you’ll have a broad understanding about what the
...
is where the majority of your work is going to take place.</p> <h2 id="fronts"><a aria-hidden="true" tabindex="-1" href="#fronts"><span class="icon icon-link"></span></a>Fronts</h2> <p>The core of any standard adventure, scenario or game session in Dungeon World
...
types and create one for each group.</p> <p>I’m going to convert an old adventure I love; I’ve run it a dozen times in a
...
under two main fronts: The Cultists and The Troglodyte Clan.</p> <p>Now, I could make the sorcerous naga that lives in the caverns her own front,
...
and operate independently, so I’ve separated them.</p> <p>Create these fronts like you would normally, choosing dangers, impending
...
front’s cast.</p> <p>If there are any traps, curses or general effects in the adventure you’d like
...
element perfectly.</p> <p>When you’re done, you’ll have a set of fronts that cover the major threats and
dangers the characters will face.</p> <h2 id="monsters"><a aria-hidden="true" tabindex="-1" href="#monsters"><span class="icon icon-link"></span></a>Monsters</h2> <p>Most published adventures contained one or two unique monsters not seen
...
from group to group, so take advantage of them where you can.</p> <p>In my adventure, the monsters run the gamut. I’ve got a scary naga with some
...
look. I use the monster creation rules to put them together.</p> <h3 id="direct-conversion"><a aria-hidden="true" tabindex="-1" href="#direct-conversion"><span class="icon icon-link"></span></a>Direct Conversion</h3> <p>If you run across a monster that you haven’t already created and which you
don’t know well enough to convert using the monster creation rules you can
instead convert them directly.</p> <h4 id="damage"><a aria-hidden="true" tabindex="-1" href="#damage"><span class="icon icon-link"></span></a>Damage</h4> <p>If the monster’s damage is a single die with a bonus of up to +10 keep it as-
...
different sizes roll only the largest and take the highest result.</p> <h4 id="hp"><a aria-hidden="true" tabindex="-1" href="#hp"><span class="icon icon-link"></span></a>HP</h4> <p>If the monster’s HP is listed as Hit Dice take the maximum value of the first
HD and add one for each additional hit dice. If the monster’s HP is listed as
a number with no Hit Dice divide the HP by 4.</p> <h4 id="armor"><a aria-hidden="true" tabindex="-1" href="#armor"><span class="icon icon-link"></span></a>Armor</h4> <p>If the monster’s AC is average give it 1 armor. If the monster’s AC is low,
...
armor if its defenses are magical.</p> <h4 id="moves-and-instinct"><a aria-hidden="true" tabindex="-1" href="#moves-and-instinct"><span class="icon icon-link"></span></a>Moves and Instinct</h4> <p>Look at the special abilities or attacks listed for the monster, these form
the basis for its moves.</p> <h2 id="maps"><a aria-hidden="true" tabindex="-1" href="#maps"><span class="icon icon-link"></span></a>Maps</h2> <p>One of the biggest differences between Dungeon World and many other fantasy
...
“ask questions and use the answers.”</p> <p>To that end, it’s often best to re-draw the map entirely, if you have time.
...
you some space to play around once you get into the game itself.</p> <p>If you don’t have the time or inclination to re-draw the map, don’t worry.
...
playing out what happens and consulting your prep as you go along.</p> <p>The maps that come with my adventure are a good mix of fun and cool and sort
...
my fronts intersect, but mostly I’ve just given myself room to explore.</p> <h2 id="magic--treasure"><a aria-hidden="true" tabindex="-1" href="#magic--treasure"><span class="icon icon-link"></span></a>Magic & Treasure</h2> <p>Two things that are, traditionally, a “big deal” in published modules are
...
strange magical staff. What rumors have you heard of its origins?”</p> <h2 id="introductory-moves"><a aria-hidden="true" tabindex="-1" href="#introductory-moves"><span class="icon icon-link"></span></a>Introductory Moves</h2> <p>This step is entirely optional, but can be really useful when running through
...
for each class, or bundle them together, if you like. Here’s an example:</p> <p>Fighter, someone who loves you gave you a gift before you left for a life of
...
something, right?</p> <ul><li>A vial of antivenom</li> <li>A shield that glows with silver light</li> <li>A rusted old key in the shape of a lizard</li></ul> <p>These sorts of moves can give the players the sense that their characters are
...
creating a great kickstart to the adventure.</p>`,1);function d(e){var t=r();o(76),a(e,t)}export{d as default};
