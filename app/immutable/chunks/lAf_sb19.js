import"./Bg9kRutz.js";import"./69_IOA4Y.js";import{n as o}from"./CUSK-jMp.js";import{a,t as n}from"./DuK_Zf15.js";var i=n(`<h1 id="fronts"><a aria-hidden="true" tabindex="-1" href="#fronts"><span class="icon icon-link"></span></a>Fronts</h1> <p>Fronts are secret tomes of GM knowledge. Each is a collection of linked
...
adventure.</p> <p>Fronts are built outside of active play. They’re the solo fun that you get to
...
them comes from preparation between sessions.</p> <p>Fronts are designed to help you organize your thoughts on what opposes the
...
turn and say, “Oh, so <em>that’s</em> what I should do.” Consider them an
organizational tool, as inspiration for present and future mayhem.</p> <p>When you’re building fronts, think about all the creepy dungeon denizens, the
...
challenge your players and ready to run Dungeon World.</p> <h3 id="when-to-make-fronts"><a aria-hidden="true" tabindex="-1" href="#when-to-make-fronts"><span class="icon icon-link"></span></a>When to Make Fronts</h3> <p>You’ll make your campaign front and first adventure fronts <em>after</em> your first
...
opportunities for future creativity.</p> <p>After that first session you’ll also make some adventure fronts. One or two is
usually a good number. If you find yourself with more adventure fronts
consider leaving some possible fronts as just notes for now.</p> <h3 id="campaign-and-adventure-fronts"><a aria-hidden="true" tabindex="-1" href="#campaign-and-adventure-fronts"><span class="icon icon-link"></span></a>Campaign and Adventure Fronts</h3> <p>At their core, all fronts contain the same components. They sort and gather
your dangers into easy-to-use clusters. There are, however, two different <em>kinds</em> of fronts available to you. On the session-to-session level there are
...
episodic content: “Today, on Dungeon World…”</p> <p>Tying your adventure fronts together is your campaign front. While the
...
importantly they’ll be scarier if they’re allowed to resolve.</p> <p>When a danger from an adventure front goes without resolution you’ll have to
...
adventure front if they’ve come to bear, too.</p> <h2 id="creating-fronts"><a aria-hidden="true" tabindex="-1" href="#creating-fronts"><span class="icon icon-link"></span></a>Creating Fronts</h2> <p>Here’s how a front comes together:</p> <ul><li>Choose campaign front or adventure front</li> <li>Create 2-3 dangers</li> <li>Choose an impending doom for each danger</li> <li>Add grim portents (1-3 for an adventure front, 3-5 for the campaign front)</li> <li>Write 1–3 stakes questions</li> <li>List the general cast of the front</li></ul> <h2 id="creating-dangers"><a aria-hidden="true" tabindex="-1" href="#creating-dangers"><span class="icon icon-link"></span></a>Creating Dangers</h2> <p>Not every element of your game will warrant a danger—traps, some roving
...
categories, each with its own name and <strong>impulse</strong>.</p> <p>Every danger has a crucial motivation that drives it called its impulse. The
impulse exists to help you understand that danger. What pushes it to fulfill
its impending doom? Impulses can help you translate the danger into action.</p> <p>When creating dangers for your front, think about how each one interacts as a
...
does each danger contribute to the front?</p> <p>Let’s say we have an idea for a front—an ancient portal has been discovered in
the icy north. We’ll call our front “The Opening of the White Gate.”</p> <p>The easiest place to start is with people and monsters. Cultists, ogre
...
rampaging centaur khanate, for example.</p> <p>For the front we’re creating, we can pick a few different groups or people who
...
just an obstacle, so we won’t make him a danger.</p> <p>Thinking more broadly, less obvious elements of the world can be dangers.
...
necromancer—they’re part of the front, a danger to the world.</p> <p>For our front, we’ll add the gate itself as a danger.</p> <p>Lastly, if we think ahead, we can include some overarching dangers. The sorts
of things that are in play outside the realm of the obvious—godly patrons,
hidden conspiracies and cursed prophecies waiting to be fulfilled.</p> <p>Perhaps the White Gate was carved in the ancient past, hidden by a race of
angels until the Day of Judgement. We’ll add the Argent Seraphim to our front
as a new danger.</p> <p>There’s always more dangers you could add to a front, but limit yourself to 3
...
uncertain, think about it this way: dangers can always get worse.</p> <p>A barbarian tribe near the gate, the frozen tundra itself, a band of rival
adventurers; all these things could be dangerous elements of the game but
they’re not important enough just yet to deserve to be dangers.</p> <p>Creating dangers is a way to slice up your overall front concept into smaller,
easier to manage pieces. Dangers are tools for adding detail to the right
parts of the front and for making the front easier to manage in the long run.</p> <p>Once you’ve named and added a danger to the front you need to choose a type
...
space as you’ll be adding to this section as you play.</p> <h3 id="custom-moves"><a aria-hidden="true" tabindex="-1" href="#custom-moves"><span class="icon icon-link"></span></a>Custom Moves</h3> <p>Sometimes a danger will suggest a move that isn’t covered by any existing
...
portent. The formatting of these moves varies from move to move.</p> <p>For the Opening of the White Gate, I just know some fool PC is going to end up
in the light that spills from the gate, so I’m writing a move to show what
might occur.</p> <p>When you <strong>stand in the presence of the Light From Beyond</strong>, roll+WIS: ✴On a
...
in the balance and art found wanting.</p> <h3 id="grim-portents"><a aria-hidden="true" tabindex="-1" href="#grim-portents"><span class="icon icon-link"></span></a>Grim Portents</h3> <p>Grim portents are dark designs for what could happen if a danger goes
...
danger towards resolving a grim portent.</p> <p>More often than not grim portents have a logical order. The orcs tear down the
...
world.</p> <p>Think of your grim portents as possible moves waiting in the wings. When the
time is right, unleash them on the world.</p> <p>I’ve chosen a few grim portents for my new front.</p> <ul><li>The College sends an expedition to the Gate</li> <li>The Key is discovered</li> <li>The First Trumpet sounds</li> <li>A Champion is chosen</li> <li>The Second Trumpet sounds</li> <li>The Herald appears</li> <li>The Gate is Opened</li></ul> <p>When a grim portent comes to pass, check it off—the prophecy has come true! A
...
across the whole campaign in subtle ways.</p> <p>You can advance a grim portent descriptively or prescriptively. Descriptively
...
comes to pass, show its effects and keep on asking, “What do you do, now?”</p> <h3 id="impending-doom"><a aria-hidden="true" tabindex="-1" href="#impending-doom"><span class="icon icon-link"></span></a>Impending Doom</h3> <p>At the end of every danger’s path is an impending doom. This is the final toll
...
of making them feel real.</p> <h3 id="stakes"><a aria-hidden="true" tabindex="-1" href="#stakes"><span class="icon icon-link"></span></a>Stakes</h3> <p>Your stakes questions are 1-3 questions about people, places, or groups that
...
reminding yourself what you want to find out.</p> <p>Stakes are concrete and clear. Don’t write stakes about vague feelings or
...
that things will never be the same again.</p> <p>The most important thing about stakes is that you find them interesting. Your
...
you have to play to find out.</p> <p>Playing to find out is one of the biggest rewards of playing Dungeon World.
You’ve written down something tied to events happening in the world that you
want to find out about—now you get to do just that.</p> <p>Once you have your stakes your front is ready to play.</p> <p>My stakes questions include, as tailored to my group:</p> <ul><li>Who will be the champion?</li> <li>How will Lux respond to the Light From Beyond?</li> <li>Will the College be able to recruit Avon?</li></ul> <h2 id="resolving-a-front"><a aria-hidden="true" tabindex="-1" href="#resolving-a-front"><span class="icon icon-link"></span></a>Resolving a Front</h2> <p>Often a front will be resolved in a simple and straightforward manner. A front
...
to the campaign front as brand new dangers?</p> <p>The campaign front will need a bit more effort to resolve. It’ll be working
...
satisfying to resolve.</p> <p>When a front is resolved take some extra time to sit down and look at the
...
reduced in stature? The resolution of a front is an important event!</p> <p>When you resolve an adventure front usually that means the adventure itself
...
go with it and get ready for the next big thing.</p> <h2 id="multiple-adventure-fronts"><a aria-hidden="true" tabindex="-1" href="#multiple-adventure-fronts"><span class="icon icon-link"></span></a>Multiple Adventure Fronts</h2> <p>As you start your campaign you’re likely to have a lightly detailed campaign
...
them or not. Think offscreen, especially where fronts are concerned.</p> <p>When running two adventure fronts at the same time they can be intertwined or
...
warring humanoid tribes that inhabit it.</p> <p>A situation warrants multiple adventure fronts when there are multiple
...
other.</p> <p>When dealing with multiple adventure fronts the players are likely to
...
Take care not to get overwhelmed.</p> <h1 id="an-example-front-the-opening-of-the-white-gate"><a aria-hidden="true" tabindex="-1" href="#an-example-front-the-opening-of-the-white-gate"><span class="icon icon-link"></span></a>An Example Front: The Opening of the White Gate</h1> <h2 id="dangers"><a aria-hidden="true" tabindex="-1" href="#dangers"><span class="icon icon-link"></span></a>Dangers</h2> <h3 id="the-college-of-arcanists-cabal"><a aria-hidden="true" tabindex="-1" href="#the-college-of-arcanists-cabal"><span class="icon icon-link"></span></a>The College of Arcanists (Cabal)</h3> <p><strong>Impulse:</strong> to absorb those in power, to grow</p> <h4 id="grim-portents-1"><a aria-hidden="true" tabindex="-1" href="#grim-portents-1"><span class="icon icon-link"></span></a>Grim Portents</h4> <ul><li>The College sends an expedition to the Gate</li> <li>The Key is discovered</li> <li>The Gate’s Power is harnessed</li> <li>The College seizes control</li></ul> <p><strong>Impending Doom:</strong> Usurpation</p> <h3 id="the-white-gate-dark-portal"><a aria-hidden="true" tabindex="-1" href="#the-white-gate-dark-portal"><span class="icon icon-link"></span></a>The White Gate (Dark Portal)</h3> <p><strong>Impulse:</strong> to disgorge demons</p> <h4 id="grim-portents-2"><a aria-hidden="true" tabindex="-1" href="#grim-portents-2"><span class="icon icon-link"></span></a>Grim Portents</h4> <ul><li>The First Trumpet sounds</li> <li>The Second Trumpet sounds</li> <li>The Gate is opened</li></ul> <p><strong>Impending Doom:</strong> Destruction</p> <h3 id="the-argent-seraphim-choir-of-angels"><a aria-hidden="true" tabindex="-1" href="#the-argent-seraphim-choir-of-angels"><span class="icon icon-link"></span></a>The Argent Seraphim (Choir of Angels)</h3> <p><strong>Impulse:</strong> to pass judgement</p> <h4 id="grim-portents-3"><a aria-hidden="true" tabindex="-1" href="#grim-portents-3"><span class="icon icon-link"></span></a>Grim Portents</h4> <ul><li>A Champion is chosen</li> <li>An organization of power is formed or co-opted</li> <li>The Herald appears</li> <li>Judgement is passed</li></ul> <p><strong>Impending Doom:</strong> Tyranny</p> <h2 id="description-and-cast-1"><a aria-hidden="true" tabindex="-1" href="#description-and-cast-1"><span class="icon icon-link"></span></a>Description and Cast</h2> <p>An ancient gate, buried for aeons in the icy north. It opens into a realm of
...
understand its terrible power.</p> <ul><li>Oren Balserus, Arcanist Supreme</li> <li>Hali’el, voice of the Seraphim</li> <li>Drudge, a manservant</li></ul> <h2 id="custom-moves-1"><a aria-hidden="true" tabindex="-1" href="#custom-moves-1"><span class="icon icon-link"></span></a>Custom Moves</h2> <p>When you <strong>stand in the presence of the Light From Beyond</strong>, roll+WIS. ✴On a
10+ you are judged worthy, the Argent Seraphim will grant you a vision or
boon. ✴On a 7-9 you are under suspicion and see a vision of what dark fate
might befall you if you do not correct your ways. ✴On a miss, thou art weighed
in the balance and art found wanting.</p> <h2 id="stakes-1"><a aria-hidden="true" tabindex="-1" href="#stakes-1"><span class="icon icon-link"></span></a>Stakes</h2> <ul><li>Who will be the Champion?</li> <li>How will Lux respond to the holy light?</li> <li>Will the College be able to recruit Avon?</li></ul>`,1);function d(e){var t=i();o(224),a(e,t)}export{d as default};
