import"./Bg9kRutz.js";import"./69_IOA4Y.js";import{n as o}from"./C-zC7P9M.js";import{a,t as n}from"./DiJJ1AKy.js";var r=n(`<h1 id="dungeon-world"><a aria-hidden="true" tabindex="-1" href="#dungeon-world"><span class="icon icon-link"></span></a>Dungeon World</h1> <h2 id="introduction"><a aria-hidden="true" tabindex="-1" href="#introduction"><span class="icon icon-link"></span></a>Introduction</h2> <p>Dungeon World is a world of fantastic adventure. A world of magic, gods and
demons, of good and evil, law and chaos. Brave heroes venture into the most
dangerous corners of the land in search of gold and glory.</p> <h2 id="why"><a aria-hidden="true" tabindex="-1" href="#why"><span class="icon icon-link"></span></a>Why?</h2> <p>Why play Dungeon World?</p> <p>First, to see the characters do <strong>amazing things</strong>. To see them explore the
...
the lives of our characters.</p> <h2 id="how-to-use-this-book"><a aria-hidden="true" tabindex="-1" href="#how-to-use-this-book"><span class="icon icon-link"></span></a>How to Use This Book</h2> <p>This book is going to teach you how to play Dungeon World. If you’re going to
...
the edge of the Pits of Madness, no.</p> <p>Forget them.</p> <p>You do this for the guts and the glory, for the scream of battle and the hot,
