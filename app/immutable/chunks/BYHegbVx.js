import"./Bg9kRutz.js";import"./69_IOA4Y.js";import{n as o}from"./C-zC7P9M.js";import{a,t as n}from"./DiJJ1AKy.js";var i=n(`<h1 id="fronts"><a aria-hidden="true" tabindex="-1" href="#fronts"><span class="icon icon-link"></span></a>Fronts</h1> <p>Fronts are secret tomes of GM knowledge. Each is a collection of linked
...
categories, each with its own name and-*impulse**.</p> <p>Every danger has a crucial motivation that drives it called its impulse. The
...
might occur.</p> <p>When you-*stand in the presence of the Light From Beyond**, roll+WIS: ✴On a
...
understand its terrible power.</p> <ul><li>Oren Balserus, Arcanist Supreme</li> <li>Hali’el, voice of the Seraphim</li> <li>Drudge, a manservant</li></ul> <h3 id="custom-moves-1"><a aria-hidden="true" tabindex="-1" href="#custom-moves-1"><span class="icon icon-link"></span></a>Custom Moves</h3> <p>When you-*stand in the presence of the Light From Beyond**, roll+WIS. ✴On a
10+ you are judged worthy, the Argent Seraphim will grant you a vision or
boon. ✴On a 7-9 you are under suspicion and see a vision of what dark fate
might befall you if you do not correct your ways. ✴On a miss, thou art weighed
in the balance and art found wanting.</p> <h3 id="stakes-1"><a aria-hidden="true" tabindex="-1" href="#stakes-1"><span class="icon icon-link"></span></a>Stakes</h3> <ul><li>Who will be the Champion?</li> <li>How will Lux respond to the holy light?</li> <li>Will the College be able to recruit Avon?</li></ul>`,1);function d(e){var t=i();o(222),a(e,t)}export{d as default};
