export default [
	{
		...
		hp: 18,
		armor: 0,
		attacks: [{ name: 'Tentacle', damage: 'd10+3', tags: 'Reach' }],
		special: 'Telepathy',
		description:
	...
	},
	{
		...
		hp: 19,
		armor: 1,
		attacks: [{ name: 'Chaotic touch', damage: 'd10', tags: 'Close, Reach' }],
		special: 'Chaos form',
		description:
	...
	},
	{
		...
		hp: 10,
		armor: 4,
		attacks: [{ name: 'Claws', damage: 'd8+1', tags: 'Close, Reach, Messy, 3 piercing' }],
		special: 'Amphibious',
		description:
	...
	},
	{
		...
		hp: 6,
		armor: 1,
		attacks: [{ name: 'Poisoned blade', damage: 'd8', tags: 'Close, 1 piercing' }],
		description:
	...
	},
	{
		...
		hp: 6,
		armor: 2,
		attacks: [{ name: 'Barbed blade', damage: '2d8 keep highest 1 +2', tags: 'Close, 1 piercing' }],
		description:
	...
	},
	{
		...
		hp: 14,
		armor: 0,
		attacks: [{ name: 'Smite', damage: 'd10+2', tags: 'Close, Reach' }],
		special: 'Divine connection',
		description:
	...
	},
	{
		...
		hp: 16,
		armor: 5,
		attacks: [{ name: 'Bite', damage: '2d12 keep highest 1 +5', tags: 'Reach, Messy, 4 piercing' }],
		special: 'Elemental blood, Wings',
		description:
	...
	},
	{
		...
		armor: 1,
		attacks: [
			{ name: 'Rending claws', damage: 'd10+3', tags: 'Close, Reach, Forceful, 3 piercing' },
		],
		description:
	...
	},
	{
		...
		hp: 7,
		armor: 4,
		attacks: [{ name: 'Flaming hammer', damage: 'd6+2', tags: 'Close, Reach' }],
		special: 'Fiery blood',
		description:
	...
	},
	{
		...
		hp: 16,
		armor: 1,
		attacks: [{ name: 'Axe', damage: 'd10+1', tags: 'Close, Reach' }],
		special: 'Unerring sense of direction',
		description:
	...
	},
	{
		...
		hp: 12,
		armor: 2,
		attacks: [{ name: 'Bite', damage: 'd10', tags: 'Close, Reach' }],
		description:
	...
	},
	{
		...
		armor: 3,
		attacks: [
			{ name: 'Flaming spear', damage: '2d6 keep highest 1 +3', tags: 'Close, Reach, Near' },
		],
		special: 'Burrowing',
		description:
