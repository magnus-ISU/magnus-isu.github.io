export default [
	...
	},
	{
		...
		hp: 10,
		armor: 1,
		attacks: [{ name: 'Talons', damage: '2d8 keep highest 1 +1', tags: 'Close, Reach, 1 piercing' }],
	...
	},
	{
		...
		special: 'Wooden',
		description: 'Old and tall and thick of bark walk amidst the tree-lined dark Strong and slow and forest-born, treants anger quick, we warn if to woods with axe ye go know the treants be thy foe',
