...
A great, leathery tome worn shiny by the hands of a hundred great generals, this book is often passed from warrior to warrior, from father to son along the great battle lines that have divided Dungeon World’s past. Anyone reading it may, upon finishing for the first time, hold 2 Remembrance.

You may spend Remembrance to advise a companion on some matter of strategic or tactical significance. They can then, at any time, regardless of distance, have you roll+INT to use the advice to aid them in service of that matter.
- On a 10+, they succeed automatically.
- On a 7+, they roll with advantage.
- On a 6-, your advice causes trouble for the poor sap who listened to you.

### [0 Weight] The Fiasco Codex
A thick tome, said to be penned in the blood of poor fools and robber-barons by some demon prince possessed of dark humor, this tome details tales and stories of those whose ambition overwhelmed their reason. Reading from this tome teaches one the value of clear-headedness but leaves a sense of dread behind.

When you read from the Fiasco Codex, Roll+WIS. On a 10+, ask two of the questions below. On a 7–9, ask one.
...
A rope that listens. Does tricks, too, like a smart and more obedient snake might. Tell it “Coil” or “Slack” or “Come here, rope” or other simple instructions and it will.
...
A common scroll has a spell inscribed on it. The spell must be lower level than you or on your class’s spell list for you to be able to cast it. When you **cast a spell from a scroll**, the spell takes effect, simple as that.

### [1 Weight] Cloak of Silent Stars
A cape of rich black velvet outside and sparkling with tiny points of light within, this cloak bends fate, time and reality around it to protect the wearer, who may defy danger with whatever stat they like. To do this, the wearer invokes the cloak’s magic and their player describes how the cloak helps “break the rules.” They can deflect a fireball with CHA by convincing it they deserve to live or elude a fall by applying the mighty logic of their INT to prove the fall won’t hurt. The cloak makes it so. It can be used once for each stat before returning to the stars to seek a new bearer.

### [0 Weight] Coin of Remembering
What appears, at a glance, to be a simple copper coin is, in truth, an enchanted coin. Its bearer can, at any time, redeem it to know immediately one fact that has been forgotten. It does not have to be a thing forgotten by the bearer, but it cannot be “known.” The coin is then forgotten by the user and those they know.

Interpretation of this stipulation is left to the gods. If the coin is unsuccessful, it will still paint an image in the mind’s eye of someone or something that does remember what was sought, but it will not be lost.
...
### [0 Weight] Lamented Memento _1 use_
...
- On a 7+, the god you name takes notice and grants you an audience. An audience with a god is not without a price:
- on a 10+, you choose one of your stats and reduce it to the next lowest modifier (for example, a 14 is +1, so it would be reduced to 12, a +0).
