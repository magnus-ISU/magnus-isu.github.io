...
- Learn a useful bit of information about your quarry
- Determine what caused the trail to end

### Called Shot
When you **shoot a defenseless or surprised enemy**, name your target and roll+DEX.
- **Torso** No roll, Deal Damage
- **Head** 10+: Deal Damage. 7+: They do nothing but stand and drool for a few moments.
- **Arms** 10+: Deal Damage. 7+: They drop anything they're holding.
...
- Ferocity +1, Cunning +2, 1 Armor, 1 Weakness

Choose as many strengths as its Ferocity: *Fast, burly, huge, calm, adaptable, quick reflexes, tireless, camouflage, ferocious, intimidating, keen senses, stealthy*

Your animal companion has training: *fight humanoids*. Choose as many additional trainings as its Cunning: *Hunt, search, scout, guard, fight monsters, perform, labor, travel*

Choose as many Weaknesses: *Flighty, savage, slow, broken, frightening, forgetful, stubborn, lame*

### Command
When you work with your animal companion on something it's trained in...
- …and you **attack the same target**, add its Ferocity to your damage
- …and you **take damage**, add its Armor to your armor
- …and you **Discern Realities, Parley, or track**, add its Cunning to your roll

## Background

### Elf
When you **Undertake a Perilous Journey through wilderness**, roll+WIS. Choose 4/3/2:
- The journey takes only as long as if there was a well-maintained road along your route.
...
### Bonds
I have guided \_\_\_\_\_ before and they owe me for it.  
\_\_\_\_\_ is a friend of nature, so I will be their friend as well.  
\_\_\_\_\_ has no respect for nature, so I have no respect for them.  
\_\_\_\_\_ does not understand life in the wild, so I will teach them.
...
### Trapper
When you **set a trap over a few minutes**, spend a use of Adventuring Gear and describe how it works and what will trigger it, then choose two effects from the following list:
- The trap deals your damage.
- The target's leg is crippled.
- The target is ensnared and cannot escape. Strong monsters can break out of the trap more quickly.
- The trap sets off a loud alarm.

When a **monster stumbles upon your trap**, roll+WIS. On a 10+, you get both effects. On a 7-9, choose one.

### Improved Traps
*Requires Trapper*  
Add the following effect to your traps:
...
### Well-Armored
Whether through your craftsmanship, its own resilience, or special training, your animal companion gets +1 Armor.
...
### Trap Mastery
*Requires Trapper*  
When your trap springs, on a 10+ choose 3 effects. On a 7-9 choose 2 effects. On a 6-, you still get one.
...
### Unnatural Ally
Your animal companion is a monster; or it has grown in skill alongside you. Describe it and why and how it changed. Give it +2 ferocity, plus a new training.

*A playbook by Magnus Anderson, Peter Johansen, Sage LaTorra, and Adam Koebel*
