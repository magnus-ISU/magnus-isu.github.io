...
When you **Parley using the Secret Tongue**, roll with WIS instead of CHA.
...
When you **use adventurer's gear and mark an area with sacred symbols**, the area is warded against one of the following so long as the symbols remain:
- Unclean spirits and perversions of nature
...
[2 Weight] Shillelagh (close)  
[1 Weight] Staff (close, two-handed)  
[1 Weight] Spear (close, thrown, near)  
Choose one:  
...
When you **awake from a deep and undisturbed slumber**, lose all your spells, then attune to your whispers and a number of leveled spells less than your level. The spells must be lower than your level.
...
When you **Shapechange**, increase your damage die to a d10.
When you **have rolled a 10 to Shapechange** you can at any time choose one of the 7-9 or 6- Shapechange options to take +1 forward.

### Formcrafter
When you **Shapechange to an appropriate form**, you can swap one of your physical stats with one of your mental ones. If you do, choose a debility for one of those two stats when the form ends.

### Austere Serenity
Your personality is as distant and inevitable as Nature herself. You become immune to charms and enchantment magic, and know when and why it is being used on you.
