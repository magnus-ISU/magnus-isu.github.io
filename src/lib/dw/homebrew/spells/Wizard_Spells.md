...
# 1 <span style="float:right">2A 2C 4D 2En 2Ev 2I 2N 2T</span>
...
### Removal <span style="float:right" >Conjuration 1</span>
Grasp an item calmly for a few seconds. It is teleported away, hidden somewhere from you within a few kilometers.
### Prepare to Die <span style="float:right" >Divination 1</span>
Receive a brief vision of your own death, overwhelming your senses, answering "What is most likely to kill me here?"
...
You write a potent illusion that lasts until you lose the quill you wrote with. When you cast the spell, say who can read it, such as "my friends and I" or "the Queen", as you understand these people to be (if you would be fooled, the spell is also). Others see a blank page, which you may then write on normally; the chosen can tell the difference.
### Corpse Puppet <span style="float:right" >Necromancy 1</span>
Briefly inhabit a corpse you can see as if it was your body, having it perform a simple task for you such as moving an item nearby or shambling somewhere you designate. It might surprise someone, but it has no strength to deal damage or grapple someone. While you control it, you can see through its senses if they still function, but do nothing with your own body.
...
# 3 <span style="float:right">2A 2C 2D 2En 2Ev 2I 2N 4T</span>
...
# 5 <span style="float:right">1A 2C 1D 1En 1Ev 1I 1N 2T</span>
...
### Polymorph  <span style="float:right" >Transmutation 5</span>
...
Transform for an instant into lightning, being able to travel in a straight line instantly as far as a kilometer, so long as there is a reasonably porous path. Any living thing you pass through takes 2d4 damage.
### Dreamweaving <span style="float:right" >Illusion 5</span>
...
# 7 <span style="float:right">0A 1C 1D 1En 2Ev 1I 1N 1T</span>
---
...
# 9 <span style="float:right">0A 2C 1D 2En 1Ev 0I 1N 0T</span>
